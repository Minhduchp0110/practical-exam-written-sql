...
VALUES
    ('E10101', 'Hai', 'Minh', '2000-01-01', 1, 'Ha Noi', 101, 50000),
    ('E10102', 'Phuong', 'Hoang', '1999-05-12', 0, 'Bac Ninh', 101, 55000),
    ('E10201', 'Thanh', 'Chi', '1985-07-23', 1, 'Bac Kan', 102, 60000),
    ('E10202', 'Viet', 'Manh', '1990-10-15', 0, 'Hai Phong', 102, 65000),
    ('E10301', 'Huy', 'Pham', '1979-03-07', 1, 'Da Nang', 103, 70000),
    ('E10302', 'Ha', 'Tran', '2003-11-28', 0, 'Hai Phong', 103, 75000);
GO
--cau 2
UPDATE Employee
